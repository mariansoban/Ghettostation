...
void lcddisp_sethome() {
    for (int i = 1; i < 5; i++) {
        ...
        case 3:
            if (!gps_fix)
                strcpy(currentline, string_shome4.copy(extract));
            else {
                char bufferl[10];
                char bufferL[10];
...
void lcddisp_setbearing() {
    ...
    for (int i = 1; i < 5; i++) {
        ...
        case 3:
            ...
            break;
        case 4:
            string_shome9.copy(currentline);
            break;
        default:
            break;
...
void lcddisp_homeok() {
    for (int i = 1; i < 5; i++) {
        ...
        case 1:
            ...
            break;
        case 2:
            string_shome10.copy(currentline);
            break;
        case 3:
            string_shome11.copy(currentline);
            break;
        case 4:
            string_shome12.copy(currentline);
            break;
        }
        for (int l = strlen(currentline); l < 20; l++) {
            strcat(currentline, " ");
...
void lcddisp_telemetry() {
    for (int i = 1; i < 5; i++) {
        ...
        switch (i) {
        case 1:
            string_telemetry1.copy(currentline);
            break;
        case 2:
            string_load2.copy(currentline);
            break;
        case 3:
            ...
            case 0:
                ...
                string_telemetry2.copy(currentline);
                break;
            case 1:
                //currentline = "MSP"; break;
                string_telemetry3.copy(currentline);
                break;
            case 2:
                //currentline = "LTM"; break;
                string_telemetry4.copy(currentline);
                break;
            case 3:
                //currentline = "MavLink"; break;
                string_telemetry5.copy(currentline);
                break;
            case 4:
                //currentline = "NMEA"; break;
                string_telemetry6.copy(currentline);
                break;
            case 5:
                //currentline = "UBLOX"; break;
                string_telemetry7.copy(currentline);
                break;
            }
            break;
        case 4:
...
void lcddisp_baudrate() {
    for (int i = 1; i < 5; i++) {
        ...
        switch (i) {
        case 1:
            string_baudrate.copy(currentline);
            break;
        case 2:
        ...
        case 3:
            ...
            case 0:
                // 1200
                string_baudrate0.copy(currentline);
                break;
            case 1:
                //2400
                string_baudrate1.copy(currentline);
                break;
            case 2:
                //4800
                string_baudrate2.copy(currentline);
                break;
            case 3:
                //9600
                string_baudrate3.copy(currentline);
                break;
            case 4:
                //19200
                string_baudrate4.copy(currentline);
                break;
            case 5:
                //38400
                string_baudrate5.copy(currentline);
                break;
            case 6:
                //57600
                string_baudrate6.copy(currentline);
                break;
            case 7:
                //115200
                string_baudrate7.copy(currentline);
                break;
            }
            break;
        case 4:
...
void lcddisp_bank() {
    for (int i = 1; i < 5; i++) {
        ...
        case 3:
            ...
            case 1:
                sprintf(currentline, "> %s", string_bank1.copy(extract));
                break;
            case 2:
                sprintf(currentline, "> %s", string_bank2.copy(extract));
                break;
            case 3:
                sprintf(currentline, "> %s", string_bank3.copy(extract));
                break;
            case 4:
                sprintf(currentline, "> %s", string_bank4.copy(extract));
                break;
            }
            break;
        case 4:
...
void lcddisp_osd() {
    for (int i = 1; i < 5; i++) {
        ...
        case 3:
            ...
            case 0:
                // NO
                string_osd3.copy(currentline);
                break;
            case 1:
                //YES
                string_osd2.copy(currentline);
                break;
            }
            break;
        case 4:
...
void lcddisp_bearing_method() {
    for (int i = 1; i < 5; i++) {
        ...
        switch (i) {
        case 1:
            string_bearing0.copy(currentline);
            break;
        case 2:
            string_load2.copy(currentline);
            break;
...
void lcddisp_voltage_ratio() {
    ...
    for (int i = 1; i < 5; i++) {
        ...
        switch (i) {
        case 1:
            string_voltage0.copy(currentline);
            break;
        case 2:
            char bufferV[6];
...
void lcddisp_testservo() {
    for (int i = 1; i < 5; i++) {
        ...
        case 1:
            ...
            break;
        case 2:
            string_servos4.copy(currentline);
            break;
        case 3:
            string_load2.copy(currentline);
            break;
